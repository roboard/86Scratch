...
class ScratchCommandHandlers:
    ...
    def perform_TurnLeft_Stage0(self, command):
        id = int(command[1])
        motion = 0
        times = int(command[2])
    ...
    def perform_TurnLeft_Stage1(self, command):
        id = int(command[1])
        motion = 1
        times = int(command[2])
        self.firmata.perform_motion(id, motion, times)
    ...
    def perform_TurnLeft_Stage2(self, command):
        id = int(command[1])
        motion = 2
        times = int(command[2])
        self.firmata.perform_motion(id, motion, times)
    ...
    def perform_TurnRight_Stage0(self, command):
        id = int(command[1])
        motion = 3
        times = int(command[2])
        self.firmata.perform_motion(id, motion, times)
    ...
    def perform_TurnRight_Stage1(self, command):
        id = int(command[1])
        motion = 4
        times = int(command[2])
        self.firmata.perform_motion(id, motion, times)
    ...
    def perform_TurnRight_Stage2(self, command):
        id = int(command[1])
        motion = 5
        times = int(command[2])
        self.firmata.perform_motion(id, motion, times)
    ...
    def perform_WalkBwd_Stage0(self, command):
        id = int(command[1])
        motion = 6
        times = int(command[2])
        self.firmata.perform_motion(id, motion, times)
    ...
    def perform_WalkBwd_Stage1(self, command):
        id = int(command[1])
        motion = 7
        times = int(command[2])
        self.firmata.perform_motion(id, motion, times)
    ...
    def perform_WalkBwd_Stage2(self, command):
        id = int(command[1])
        motion = 8
        times = int(command[2])
        self.firmata.perform_motion(id, motion, times)
    ...
    def perform_WalkFwd_Stage0(self, command):
        id = int(command[1])
        motion = 9
        times = int(command[2])
        self.firmata.perform_motion(id, motion, times)
    ...
    def perform_WalkFwd_Stage1(self, command):
        id = int(command[1])
        motion = 10
        times = int(command[2])
        self.firmata.perform_motion(id, motion, times)
    ...
    def perform_WalkFwd_Stage2(self, command):
        id = int(command[1])
        motion = 11
        times = int(command[2])
        self.firmata.perform_motion(id, motion, times)
    ...
    def perform_WalkLeft_Stage0(self, command):
        id = int(command[1])
        motion = 12
        times = int(command[2])
        self.firmata.perform_motion(id, motion, times)
    ...
    def perform_WalkLeft_Stage1(self, command):
        id = int(command[1])
        motion = 13
        times = int(command[2])
        self.firmata.perform_motion(id, motion, times)
    ...
    def perform_WalkLeft_Stage2(self, command):
        id = int(command[1])
        motion = 14
        times = int(command[2])
        self.firmata.perform_motion(id, motion, times)
    ...
    def perform_WalkRight_Stage0(self, command):
        id = int(command[1])
        motion = 15
        times = int(command[2])
        self.firmata.perform_motion(id, motion, times)
    ...
    def perform_WalkRight_Stage1(self, command):
        id = int(command[1])
        motion = 16
        times = int(command[2])
        self.firmata.perform_motion(id, motion, times)
    ...
    def perform_WalkRight_Stage2(self, command):
        id = int(command[1])
        motion = 17
        times = int(command[2])
        self.firmata.perform_motion(id, motion, times)
    ...
    def perform_TurnLeft(self, command):
        id = int(command[1])
        motion = 18
        times = int(command[2])
        self.firmata.perform_motion(id, motion, times)
    ...
    def perform_TurnRight(self, command):
        id = int(command[1])
        motion = 19
        times = int(command[2])
        self.firmata.perform_motion(id, motion, times)
    ...
    def perform_WalkBwd(self, command):
        id = int(command[1])
        motion = 20
        times = int(command[2])
        self.firmata.perform_motion(id, motion, times)
    ...
    def perform_WalkFwd(self, command):
        id = int(command[1])
        motion = 21
        times = int(command[2])
        self.firmata.perform_motion(id, motion, times)
    ...
    def perform_WalkLeft(self, command):
        id = int(command[1])
        motion = 22
        times = int(command[2])
        self.firmata.perform_motion(id, motion, times)
    ...
    def perform_WalkRight(self, command):
        id = int(command[1])
        motion = 23
        times = int(command[2])
        self.firmata.perform_motion(id, motion, times)
    ...
    def perform_helloworld(self, command):
        id = int(command[1])
        motion = 24
        times = int(command[2])
        self.firmata.perform_motion(id, motion, times)
    ...
    command_dict = {'crossdomain.xml': send_cross_domain_policy, 'reset_all': reset_arduino,
                    ...
                    'perform_TurnLeft_Stage0': perform_TurnLeft_Stage0,
                    'perform_TurnLeft_Stage1': perform_TurnLeft_Stage1,
                    'perform_TurnLeft_Stage2': perform_TurnLeft_Stage2,
                    'perform_TurnRight_Stage0': perform_TurnRight_Stage0,
                    'perform_TurnRight_Stage1': perform_TurnRight_Stage1,
                    'perform_TurnRight_Stage2': perform_TurnRight_Stage2,
                    'perform_WalkBwd_Stage0': perform_WalkBwd_Stage0,
                    'perform_WalkBwd_Stage1': perform_WalkBwd_Stage1,
                    'perform_WalkBwd_Stage2': perform_WalkBwd_Stage2,
                    'perform_WalkFwd_Stage0': perform_WalkFwd_Stage0,
                    'perform_WalkFwd_Stage1': perform_WalkFwd_Stage1,
                    'perform_WalkFwd_Stage2': perform_WalkFwd_Stage2,
                    'perform_WalkLeft_Stage0': perform_WalkLeft_Stage0,
                    'perform_WalkLeft_Stage1': perform_WalkLeft_Stage1,
                    'perform_WalkLeft_Stage2': perform_WalkLeft_Stage2,
                    'perform_WalkRight_Stage0': perform_WalkRight_Stage0,
                    'perform_WalkRight_Stage1': perform_WalkRight_Stage1,
                    'perform_WalkRight_Stage2': perform_WalkRight_Stage2,
                    'perform_TurnLeft': perform_TurnLeft,
                    'perform_TurnRight': perform_TurnRight,
                    'perform_WalkBwd': perform_WalkBwd,
                    'perform_WalkFwd': perform_WalkFwd,
                    'perform_WalkLeft': perform_WalkLeft,
                    'perform_WalkRight': perform_WalkRight,
                    'perform_helloworld': perform_helloworld,
                    'perform_bow': perform_bow,
                    'perform_grab': perform_grab,
